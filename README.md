...
`contributions/` is a searchable timeline of the account's public
contributions, as GitHub records them. It is static HTML, CSS and a data
file, regenerated by one command:
